...
import {
    FiMapPin, FiCalendar, FiUser, FiArrowLeft, FiCheck, FiLoader, FiAlertCircle
} from 'react-icons/fi';
                    ...
                    <form onSubmit={handleSubmit} className="space-y-10">
                        ...
                        {(rf.requireAddress || rf.requirePassport || rf.requireIdProof) && (
                            <div className="space-y-6 pt-8 border-t border-gray-100">
                                <h3 className="text-lg font-bold text-gray-900">Logistics & ID</h3>
                                <div className="grid grid-cols-1 gap-6">
                                    {rf.requireAddress && (
                                        <div className="space-y-2">
                                            <label className="text-sm font-semibold text-gray-700">Full Address *</label>
                                            <textarea name="address" rows={3} value={formData.address} onChange={handleChange} required className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all text-sm resize-none" placeholder="Enter your full address" />
                                        </div>
                                    )}
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        {rf.requirePassport && (
                                            <div className="space-y-2">
                                                ...
                                                <input type="text" name="passportId" value={formData.passportId} onChange={handleChange} required className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all text-sm" placeholder="ID Number" />
                                            </div>
                                        )}
                                        {rf.requireIdProof && (
                                            <div className="space-y-2">
                                                ...
                                                >
                                                    {isUploadingIdProof ? <FiLoader className="animate-spin mx-auto" /> : idProofFile ? 'File Uploaded Successfully' : 'Click to Upload ID File'}
                                                </div>
